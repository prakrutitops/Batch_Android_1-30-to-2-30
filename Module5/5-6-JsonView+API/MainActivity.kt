...
import com.example.jsonview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        var stringRequest =StringRequest(Request.Method.GET,"https://www.simplifiedcoding.net/demos/view-flipper/heroes.php",
            {
                    response->
                    try
                    {
